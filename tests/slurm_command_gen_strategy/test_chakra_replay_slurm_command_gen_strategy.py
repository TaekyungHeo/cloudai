...
@pytest.mark.parametrize(
    ...
    [
        (
            "chakra_replay",
            {"NCCL_DEBUG": "INFO"},
            {"docker_image_url": "fake_image_url", "trace_dir": "/workspace/traces/"},
            {"image_path": "fake_image_url", "container_mounts": ["/workspace/traces/:/workspace/traces/"]},
        ),
        (
            "chakra_replay",
            {"NCCL_DEBUG": "INFO"},
...
@pytest.mark.parametrize(
    ...
    [
        (
            {"trace_dir": "/workspace/traces/", "warmup_iters": 5, "iters": 10},
            {
                "trace": {"directory": "/workspace/traces/"},
                "replay": {"warmup_iters": 5, "iters": 10},
            },
        ),
        (
            {"trace_dir": "/another/path/", "warmup_iters": 2, "iters": 20},
            {
                ...
                "replay": {"warmup_iters": 2, "iters": 20},
            },
        ),
        (
            {
            ...
            },
            {
                ...
                "replay": {"warmup_iters": 0, "iters": 50},
                "profiler": {"enabled": True},
                "backend": {"name": "custom_backend"},
                "logging": {"level": "DEBUG"},
        ...
        (
            ...
            },
            {
                ...
                "replay": {"warmup_iters": 3, "iters": 15},
                "backend": {"name": "advanced_backend"},
